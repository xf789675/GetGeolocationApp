...
public class DistanceFilterLocationProvider extends AbstractLocationProvider implements LocationListener {
    ...
    private void setPace(Boolean value) {
        ...
        try {
            ...
            //         Toast.makeText(locationService, "10-Get Best Provider!", Toast.LENGTH_LONG).show();
            //     }
    ...
    */
    ...
    //         if (config.isDebugging()) {
    //             Toast.makeText(locationService, "1-isAcquiringStationaryLocation", Toast.LENGTH_LONG).show();
    //         }
    ...
    //             isAcquiringStationaryLocation = false;
    //             if (config.isDebugging()) {
    //                 Toast.makeText(locationService, "2-startMonitoringStationaryRegion", Toast.LENGTH_LONG).show();
    //             }
    ...
    //         if (config.isDebugging()) {
    //             Toast.makeText(locationService, "7-isAcquiringSpeed", Toast.LENGTH_LONG).show();
    //         }
    ...
    //             }
    //             if (config.isDebugging()) {
    //                 Toast.makeText(locationService, "8-calculateDistanceFilter", Toast.LENGTH_LONG).show();
    //             }
    //             isAcquiringSpeed = false;
    //             scaledDistanceFilter = calculateDistanceFilter(location.getSpeed());
    //             if (config.isDebugging()) {
    //                 Toast.makeText(locationService, "9-distanceFilter: " + scaledDistanceFilter, Toast.LENGTH_LONG).show();
    //             }
    //             setPace(true);
    //         } else {
    //             if (config.isDebugging()) {
    ...
    //         if (config.isDebugging()) {
    //             Toast.makeText(locationService, "12-calculateDistanceFilter", Toast.LENGTH_LONG).show();
    //         }
    ...
    //         }
    //         if (config.isDebugging()) {
    //             Toast.makeText(locationService, "13-distanceFilter: " + scaledDistanceFilter, Toast.LENGTH_LONG).show();
    //         }
    ...
    //     if (config.isDebugging()) {
    //         Toast.makeText(locationService, "Get location Success!", Toast.LENGTH_LONG).show();
    //     }
    ...
    //         Toast.makeText(locationService, "6-ExitStationaryRegion", Toast.LENGTH_LONG).show();
    //     }
    ...
    //     if (config.isDebugging()) {
    //         Toast.makeText(locationService, "3-startPollingStationaryLocation", Toast.LENGTH_LONG).show();
    //     }
    ...
    //     if (config.isDebugging()) {
    //         Toast.makeText(locationService, "4-onPollStationaryLocation", Toast.LENGTH_LONG).show();
    //     }
    //     float stationaryRadius = config.getStationaryRadius();
    //     if (isMoving) {
    //         return;
    ...
    //         if (config.isDebugging()) {
    //             Toast.makeText(locationService, "5-onExitStationaryRegion", Toast.LENGTH_LONG).show();
    //         }
    ...
    */
    ...
    //         if (config.isDebugging()) {
    //             Toast.makeText(locationService, "stationaryAlarm fired", Toast.LENGTH_LONG).show();
    //         }
    //         setPace(false);
    //     }
    // };
    ...
    //              Toast.makeText(locationService, "Stationary location monitor fired", Toast.LENGTH_LONG).show();
    //          }
    ...
    //              Toast.makeText(locationService, "stationaryRegionReceiver fired! entering = " + entering, Toast.LENGTH_LONG).show();
    //          }
    //         if (entering) {
